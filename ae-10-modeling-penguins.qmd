...
-   **Question:** Based on our research focus, which variable is the response variable?
    -   *Body mass is the responding variable*.
...
$$
Body~mass = -5780.83136+ 49.68557 \times flipper~length 
$$
...
The manipulated variable is a categorical variable instead of numerical.
